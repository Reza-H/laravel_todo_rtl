...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('فراموشی گذرواژه') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('password.email') }}" id="sendPassEmailForm">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('لینک تعویض گذرواژه را بفرست') }}
                                </button>
                            </div>
                        </div>
                    </form>
